 ...
 * for size and color customization. Uses currentColor for fill/stroke
 * so the icon inherits the parent's text color.
 *
 * To add a new icon: create a named export with the SVG path.
 */
