...
const TAG_RULES: TagRule[] = [
  {
    tag: 'Performance',
    keywords: [
      'perf', 'fps', 'frame', 'speed', 'memory', 'cache', 'async',
      'thread', 'batch', 'budget', 'throttle', 'maxfps', 'framerate',
      'optimization', 'optimize', 'fast', 'cull', 'skip', 'lazy',
      'defer', 'reduce', 'limit', 'pool', 'cap', 'ratelimit',
      'instant', 'preempt', 'priorit', 'schedul', 'multithread',
      'parallel', 'job', 'wait', 'timeout', 'stall', 'hitch',
      'lag', 'buffer', 'stream', 'chunk', 'incremental',
    ],
  },
  {
    tag: 'Graphics',
    keywords: [
      'render', 'graphic', 'shadow', 'texture', 'mesh', 'lighting',
      'material', 'shader', 'voxel', 'particle', 'posteffect', 'bloom',
      'ambient', 'quality', 'resolution', 'antialias', 'msaa', 'aniso',
      'color', 'pixel', 'vertex', 'fragment', 'draw', 'paint',
      'visual', 'vfx', 'glow', 'reflect', 'refract', 'specular',
      'diffuse', 'emissive', 'opacity', 'transparency', 'blend',
      'terrain', 'sky', 'fog', 'atmosphere', 'sun', 'moon',
      'water', 'ocean', 'cloud', 'shadowmap', 'depthbuffer',
      'rendertarget', 'framebuffer', 'gbuffer', 'hdr', 'ldr',
      'tone', 'exposure', 'gamma', 'srgb', 'linear',
      'raster', 'ray', 'trace', 'globalillum', 'gi', 'ao',
      'ssao', 'bloom', 'lens', 'dof', 'motionblur', 'taa',
      'fxaa', 'smaa', 'supersampl', 'upscale', 'dlss', 'fsr',
    ],
  },
  {
    tag: 'Fix',
    keywords: [
      'fix', 'bug', 'crash', 'patch', 'workaround', 'disable',
      'hack', 'mitigate', 'resolve', 'repair', 'correct', 'revert',
      'rollback', 'safeguard', 'guard', 'clamp', 'validate',
      'sanitize', 'bounds', 'overflow', 'underflow', 'null',
      'divide', 'infinity', 'nan', 'assert', 'check',
    ],
  },
  {
    tag: 'UI',
    keywords: [
      'ui', 'gui', 'menu', 'button', 'input', 'mouse', 'keyboard',
      'touch', 'chat', 'notification', 'screen', 'display', 'hud',
      'overlay', 'dialog', 'modal', 'tooltip', 'dropdown', 'scroll',
      'list', 'grid', 'panel', 'tab', 'sidebar', 'toolbar', 'navbar',
      'header', 'footer', 'avatar', 'badge', 'icon', 'label',
      'text', 'font', 'size', 'scale', 'zoom', 'dpi', 'accessibility',
      'a11y', 'cursor', 'pointer', 'click', 'drag', 'hover',
      'focus', 'select', 'copy', 'paste', 'contextmenu',
      'radial', 'healthbar', 'nametag', 'leaderboard', 'inventory',
    ],
  },
  {
    tag: 'LOD',
    keywords: [
      'lod', 'level', 'distance', 'farclip', 'cull', 'stream',
      'mipmap', 'impostor', 'billboard', 'simplify', 'detail',
      'fade', 'popin', 'popout', 'occlusion', 'visibility',
      'renderdistance', 'drawdistance', 'viewdist',
    ],
  },
  {
    tag: 'Experimental',
    keywords: [
      'experimental', 'debug', 'beta', 'preview', 'test', 'dev',
      'internal', 'prototype', 'wip', 'tentative', 'lab', 'unstable',
      'risky', 'advanced', 'poweruser', 'danger',
    ],
  },
  {
    tag: 'Unknown',
